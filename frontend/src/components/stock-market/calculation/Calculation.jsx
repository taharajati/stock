...
<div className="mb-6 max-w-[300px]">
  ...
  <Select
    ...
    isSearchable
    className="rtl text-right border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
  />
</div>
...
<div className="mb-6 max-w-[300px] ">
  ...
  <Select
    options={strategyList.map(strategy => ({
      value: strategy,
      label: strategy,
    }))}
    onChange={(selectedOption) => {
...
<div className="mb-6 max-w-[300px] ">
  ...
  <input
    ...
    className="border p-3 rounded-md w-full focus:outline-none focus:ring-2 focus:ring-primary-500"
  />
</div>
...
{selectedStrategy && (
  <div className="mb-6 max-w-screen-xl mx-auto px-4">
      ...
      <div key={index} className="mb-6 p-6 border rounded-lg bg-white shadow-xl grid grid-cols-5 gap-6">
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            className="border p-3 rounded-md w-full bg-gray-50 text-gray-600"
        ...
        <div className="flex flex-col">
          ...
          {data.asset_type === "stock" ? (
            ...
            <select
              className="p-3 border rounded-md w-full bg-gray-50 text-gray-600"
              value={data.kind || ''}
        ...
        <div className="flex flex-col">
          ...
          {data.asset_type !== "stock" ? (
            ...
            >
              ...
              {getUniqueEndDates(intraData).map((date, idx) => (
        ...
        <div className="flex flex-col">
          ...
          {data.kind ? (
            <select
              className="w-full border p-3 rounded-md bg-gray-50 text-gray-600"
    ...
    <button
      ...
      className="bg-[color:var(--color-bg-variant)] hover:bg-[color:var(--color-primary)] text-white py-3 px-6 rounded-md transition-all mt-6 shadow-lg w-full sm:w-auto"
    >
      محاسبه
    </button>
  </div>
...
{response && (
  <div className="mt-6 p-8 border rounded-xl bg-white shadow-xl hover:shadow-2xl transition-all duration-300">
    <h3 className="font-extrabold text-2xl text-right text-blue-800 border-b-4 pb-3 mb-6 border-blue-600">نتیجه استراتژی</h3>
